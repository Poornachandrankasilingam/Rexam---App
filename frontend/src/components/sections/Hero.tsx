...
export function Hero() {
  return (
    <section className="relative pt-32 pb-24 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-emerald-600/20 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute top-10 right-10 w-96 h-96 bg-teal-400/15 rounded-full blur-[130px] pointer-events-none" />
      <div className="absolute bottom-10 left-10 w-96 h-96 bg-green-500/15 rounded-full blur-[130px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center space-y-10">
          ...
          >
            {/* 3D Pill Badge */}
            <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full text-xs md:text-sm font-bold bg-emerald-500/15 text-emerald-300 border border-emerald-400/30 shadow-lg shadow-emerald-500/10">
            ...
            <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl text-slate-200 leading-relaxed font-normal">
              Empowering aspirants for <span className="text-emerald-400 font-semibold">SSC, UPSC, Banking & Railways</span> with AI exam generation, instant solution breakdowns, and diagnostic performance analytics.
            </p>

            {/* Action Buttons */}
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/register">
                <Button size="lg" className="btn-3d-green rounded-full h-14 px-9 text-base font-bold text-white shadow-2xl shadow-emerald-500/25">
                  Get Started Free
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link to="/student/practice">
                <Button variant="outline" size="lg" className="rounded-full h-14 px-8 text-base font-bold glass glass-hover text-white border-emerald-400/30">
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="text-xl font-bold font-outfit text-white group-hover:text-emerald-300 transition-colors">{feature.title}</h3>
